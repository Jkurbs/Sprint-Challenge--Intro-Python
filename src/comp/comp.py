...
c = [person.name for person in humans if person.name.startswith(map(chr, range(ord('C'), ord('G'))))]
print(c)
...
f = [person for person in humans if person.age < 32 and person.age > 27]
print(f[0])
